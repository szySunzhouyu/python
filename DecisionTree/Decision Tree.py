...
# 当特征划分到只有一个，但是依然无法归为一类时即树无法停止构造，此时采用最大投票法，选择最多类别作为该类标签
...
def plotNode(nodeTxt, centerPt, parentPt, nodeType):
    ...
    font = FontProperties(fname=r"/usr/share/fonts/truetype/wqy/wqy-microhei.ttc",size=14)  # 设置中文字体
